...
const WorkforcesSplitDemo = () => {
    return (
        <div className="w-full h-[600px] flex flex-col rounded-2xl border border-white/5 bg-[#111] overflow-hidden shadow-2xl relative font-sans">
            {/* Mac Window Header */}
            ...
            <div className="flex-1 flex flex-row overflow-hidden">
                {/* Left Panel: Swarm Demo (50%) */}
                <div className="w-1/2 flex bg-white border-r border-gray-200 z-10 relative overflow-hidden">
                    {/* Config Sidebar */}
                    <div className="w-[120px] xl:w-[140px] flex-shrink-0 h-full bg-gray-50/50 border-r border-gray-200 p-4 flex flex-col gap-4">
                ...
                {/* Right Panel: Workflow Demo (50%) */}
                <div className="w-1/2 relative overflow-hidden bg-[#fafafa]" style={{
                    backgroundImage: 'radial-gradient(#e2e8f0 1px, transparent 1px)',
                    backgroundSize: '24px 24px'
                }}>
                    {/* Title Label */}
            ...
            <div className="container mx-auto px-4 sm:px-10 lg:px-20 relative z-10">
                ...
                <div className="flex flex-col w-full border border-dashed border-white/15 rounded-3xl overflow-hidden shadow-2xl bg-[#0A0A0A]">
                    ...
                    <div className="border-b border-dashed border-white/15 flex flex-col transition-all duration-300 hover:shadow-indigo-500/10 group bg-[#0A0A0A] relative z-10">
                        <div className="p-8 md:p-10 border-b border-white/5">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                                <h3 className="text-3xl font-bold text-white">Sovereign Agents</h3>
                                <Link href={ROUTES.SIGNUP} className="group relative shrink-0 inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-b from-white/10 to-white/5 border border-white/10 text-white font-medium overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:border-indigo-500/50 hover:shadow-[0_0_40px_-10px_rgba(99,102,241,0.4)]">
                    ...
                    <div className="flex flex-col transition-all duration-300 hover:shadow-purple-500/10 group bg-[#0A0A0A] relative z-10">
                        <div className="p-8 md:p-10 border-b border-white/5">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                                <h3 className="text-3xl font-bold text-white">AI Workforces</h3>
