...
interface PublishEntityModalProps {
    ...
    /** Optional rich context about the entity — shown as a read-only info banner */
...
export function PublishEntityModal({
    ...
    /** Primary listing category; defaults to `other` when the user skips the picker. */
    const resolvedCategory = selectedCategories[0] ?? "other";
    ...
    }, [open, entityId, resolvedEntityType]);
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent showCloseButton={false} className="sm:max-w-4xl p-0 overflow-hidden border-none shadow-2xl h-[85vh] sm:max-h-[85vh] flex flex-col gap-0 bg-white dark:bg-zinc-950">
                ...
                <DialogDescription className="sr-only">Configure and publish your listing to the marketplace.</DialogDescription>
                    ...
                    <div className="flex-1 flex items-center justify-center gap-2.5">
                        {screen === "preview" ? (
                            ...
                            <>
                                ...
                                <span className="text-[15px] font-bold text-zinc-900 dark:text-zinc-100 tracking-tight">Publish to Marketplace</span>
                            </>
                        )}
                    </div>
