      ...
      <div className="space-y-6">
          ...
          >
            ...
            <ChevronDown
              className={`h-4 w-4 text-slate-400 transition-all ${
                welcomeExpanded ? "rotate-0" : "-rotate-90"
              }`}
            />
          </button>
          {welcomeExpanded && (
              ...
              {WELCOME_ITEMS.map((section) => {
                ...
                return (
                  <button
                    ...
                    className={`flex w-full cursor-pointer items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium ${
        ...
        <div>
          ...
          >
            ...
            <ChevronDown
              className={`h-4 w-4 text-slate-400 transition-all ${
                supportExpanded ? "rotate-0" : "-rotate-90"
              }`}
            />
          </button>
          {supportExpanded && (
        ...
        <div>
          ...
          >
            ...
            <ChevronDown
              className={`h-4 w-4 text-slate-400 transition-all ${
                discussionExpanded ? "rotate-0" : "-rotate-90"
              }`}
            />
          </button>
          {discussionExpanded && (
