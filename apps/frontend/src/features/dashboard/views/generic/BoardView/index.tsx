...
export function BoardView({ spaceId, projectId, teamId, listId, folderId, viewId, workspaceId, initialConfig, selectedTaskIdFromParent, onTaskSelect, scope, context }: BoardViewProps) {
    ...
    const viewContentToSave = useMemo(() => {
        return {
            ...
            columns: settings.visibleFields,
        };
    }, [
        viewId, viewData, workspaceId, resolvedWorkspaceId, spaceId, projectId, folderId, listId, teamId,
        groupBy, groupDirection, expandedSubtaskMode, showCompleted,
        showCompletedSubtasks, showTasksFromOtherLists, showSubtasksFromOtherLists,
        defaultToMeMode, filterGroups, viewAutosave, settings
    ]);
