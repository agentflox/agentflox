...
export function MindMapView(props: MindMapViewProps) {
    ...
    const viewContentToSave = useMemo(() => {
        return {
            id: props.viewId,
            name: viewNameDraft || (props.entity as any)?.name || "Mind Map",
            type: "MIND_MAP",
            workspaceId: (props.workspaceId || resolvedWorkspaceId) ?? undefined,
        ...
        props.viewId, props.entity, props.workspaceId, props.spaceId, props.projectId,
        props.folderId, props.listId, props.teamId, viewNameDraft, resolvedWorkspaceId,
        showMinimap, viewAutosave, defaultToMeMode, filterGroups, mode
    ]);
...
function MindMapTasksView(props: MindMapHeaderProps) {
    ...
    return (
        <div className={cn("h-full flex flex-col bg-white shadow-sm overflow-hidden relative", isFullscreen && "fixed inset-0 z-50")}>
            <MindMapHeader {...props} />
            <div className="border-b border-zinc-100 bg-zinc-50/30 px-3 py-1.5 shrink-0 flex items-center justify-between">
