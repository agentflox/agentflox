...
interface DashboardTeamViewProps {
    listId?: string;
    spaceId?: string;
    projectId?: string;
    teamId?: string;
...
export default function DashboardTeamView({ listId, spaceId, projectId, teamId, workspaceId, selectedTaskIdFromParent, onTaskSelect }: DashboardTeamViewProps) {
    ...
    // Fetch team data with views
    const { data: teamData } = trpc.team.get.useQuery(
        { id: teamId! },
        { enabled: !!teamId, staleTime: 60_000, gcTime: 5 * 60_000 }
    );
                ...
                <div className="flex flex-col items-center gap-6 max-w-sm text-center">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <p className="text-sm text-slate-500 leading-relaxed">
                            This team doesn't exist or you don't have permission to access it. Check the URL or ask your workspace admin.
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-2 text-xs text-slate-400">
                        ...
                        <span>Team ID: <code className="font-mono text-slate-500">{teamId ?? "—"}</code></span>
                    </div>
                </div>
            </div>
        );
