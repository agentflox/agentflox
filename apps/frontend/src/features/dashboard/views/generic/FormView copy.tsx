...
function SortableField({ field, onDelete, onUpdate, onDuplicate, onOpenAdvancedSettings }: {
    field: FormField;
                ...
                >
                    ...
                    <Popover open={settingsOpen} onOpenChange={setSettingsOpen}>
                        ...
                        <PopoverContent
                            align="end"
                            sideOffset={10}
                            className="w-[360px] p-0 font-sans shadow-xl rounded-2xl overflow-hidden animate-in zoom-in-95 duration-200 z-50"
                        >
                            <div className="px-4 pt-4 flex items-center gap-2">
                                <div>
                                    <div className="text-[16px] leading-tight font-bold tracking-tight text-zinc-900">Configure field</div>
                            ...
                            <div className="px-4 py-3 border-t border-zinc-100 bg-zinc-50 flex items-center justify-between gap-2">
                                <Button
                                    ...
                                    className="h-8 px-3 text-[12px] font-semibold rounded-md border-zinc-300 text-zinc-600 hover:text-zinc-800 hover:bg-zinc-100 cursor-pointer"
                                >
    ...
    return (
        <div className="flex h-full min-h-0 min-w-0 flex-col bg-slate-50">
                                                        ...
                                                        {fields.map((field, fieldIndex) => (
                                                            <Fragment key={field.id}>
                                                                <SortableField
                                                                    ...
                                                                    onOpenAdvancedSettings={() => setCustomFieldsManagerOpen(true)}
                                                                />
            ...
            <CustomFieldsManagerModal
                ...
                onOpenChange={setCustomFieldsManagerOpen}
                workspaceId={resolvedWorkspaceId || ""}
            />
