...
interface TeamPersonalViewProps {
    teamId: string;
    workspaceId: string;
    personalTab?: string;
    taskSubView?: string;
...
export default function TeamPersonalView({ teamId, workspaceId, personalTab, taskSubView, viewId }: TeamPersonalViewProps) {
    ...
    const renderContent = () => {
        const props = { teamId, workspaceId, context: "team" as const };
        switch (activeTab) {
