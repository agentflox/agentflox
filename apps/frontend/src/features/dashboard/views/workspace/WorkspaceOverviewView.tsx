				...
				<div className="w-full px-6 py-6 space-y-5">
					...
					<div className="relative rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
						<div
							...
							style={{
								background: `radial-gradient(ellipse 80% 60% at 70% 50%, #6366f1, transparent)`,
							}}
						/>
						<div
							className="absolute top-0 left-0 right-0 h-0.5"
							style={{ background: `linear-gradient(90deg, #6366f1cc, transparent)` }}
						/>

						<div className="relative z-10 flex flex-col sm:flex-row gap-5 items-start p-6">
							<div
								className="h-12 w-12 rounded-xl flex items-center justify-center border shrink-0 bg-indigo-50 border-indigo-200 text-indigo-500"
							>
							...
							{spaces.length === 0 ? (
								...
								<div className="divide-y divide-slate-50">
									{spaces.slice(0, 6).map((space: any) => {
										const url = `/dashboard/spaces/${space.id}`;
										return (
											<div
												key={space.id}
											...
											>
												...
												>
													<SpaceIcon icon={space.icon} size={14} className="text-white" />
												</div>
									...
									{spaces.length > 6 && (
										<div className="px-5 py-2 text-xs text-slate-400 hover:text-slate-600 cursor-pointer hover:bg-slate-50 transition-colors" onClick={() => router.push('/dashboard/spaces')}>
						...
						<div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
							...
							{projects.length === 0 ? (
								...
								<div className="divide-y divide-slate-50">
									...
									{projects.length > 6 && (
										<div className="px-5 py-2 text-xs text-slate-400 hover:text-slate-600 cursor-pointer hover:bg-slate-50 transition-colors" onClick={() => router.push('/dashboard/projects')}>
						...
						<div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
							...
							{teams.length === 0 ? (
								...
								<div className="divide-y divide-slate-50">
									...
									{teams.length > 6 && (
										<div className="px-5 py-2 text-xs text-slate-400 hover:text-slate-600 cursor-pointer hover:bg-slate-50 transition-colors" onClick={() => router.push('/dashboard/teams')}>
						...
						<div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
							...
							{channels.length === 0 ? (
								...
								<div className="divide-y divide-slate-50">
									...
									{channels.length > 8 && (
										<div className="px-5 py-2 text-xs text-slate-400 hover:text-slate-600 cursor-pointer hover:bg-slate-50 transition-colors" onClick={() => router.push('/dashboard/channels')}>
						...
						<div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
							...
							{folders.length === 0 ? (
								...
								<div className="divide-y divide-slate-50">
									...
									{folders.length > 8 && (
										<div className="px-5 py-2 text-xs text-slate-400 hover:text-slate-600 cursor-pointer hover:bg-slate-50 transition-colors" onClick={() => router.push('/dashboard/folders')}>
						...
						<div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
							...
							{lists.length === 0 ? (
								...
								<div className="divide-y divide-slate-50">
									...
									{lists.length > 8 && (
										<div className="px-5 py-2 text-xs text-slate-400 hover:text-slate-600 cursor-pointer hover:bg-slate-50 transition-colors" onClick={() => router.push('/dashboard/lists')}>
