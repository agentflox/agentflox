                ...
                <TooltipTrigger asChild>
                  ...
                  >
                    <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-zinc-200 bg-zinc-50">
                      {s.id === "llm" ? <LuBrain className="h-4.5 w-4.5 text-indigo-600" /> : null}
                      {s.id === "api" ? <TbApi className="h-4.5 w-4.5 text-sky-600" /> : null}
                      ...
                      {s.id === "python" ? <IoLogoPython className="h-4.5 w-4.5 text-emerald-600" /> : null}
                      {s.id === "javascript" ? <IoLogoJavascript className="h-4.5 w-4.5 text-amber-600" /> : null}
                    </span>
