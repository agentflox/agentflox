...
import { Filter, Globe, Tag } from "lucide-react";
			...
			<div className="space-y-6">
				<div className="space-y-6">
					...
					>
						...
						{scope === "owned" && (
							<Select value={filters.status || "all"} onValueChange={(v) => setFilters((f: any) => ({ ...f, status: v === "all" ? "" : v as any }))}>
								<SelectTrigger className="w-[180px]">
						...
						<Select value={filters.country || "all"} onValueChange={(v) => setFilters((f: any) => ({ ...f, country: v === "all" ? undefined : v as any }))}>
							<SelectTrigger className="w-[180px]">
