      ...
      <div className="flex flex-col min-h-full">
        ...
        <div className="sticky top-0 z-20 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md border-b border-zinc-200/80 dark:border-zinc-800/80 shadow-xs px-6 pt-6 pb-4 transition-all">
          <PageHeader
            ...
            actions={
              <Link href="/analytics" className="inline-block shrink-0">
                <Button
                  className={[
                    "relative overflow-hidden border-0 text-white shadow-lg shadow-violet-900/30",
                    ...
                    "inline-flex w-fit shrink-0 items-center justify-center transition-all duration-200",
                  ].join(" ")}
                >
                  <span
                    aria-hidden
                  ...
                  />
                  <BarChart2 className="relative h-4 w-4" />
