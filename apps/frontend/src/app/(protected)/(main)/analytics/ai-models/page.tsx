...
export default function AiModelsUsagePage() {
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto">
      <div className="sticky top-0 z-20 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md border-b border-zinc-200/80 dark:border-zinc-800/80 shadow-xs px-8 pt-4 pb-4 transition-all">
        <div className="pb-2">
          <Button
            variant="ghost"
            onClick={() => router.push('/analytics')}
            className="text-muted-foreground hover:text-foreground mb-2 -ml-3"
          >
        ...
        <PageHeader
          ...
          actions={
            <Link href="/billing" className="inline-block shrink-0">
              <Button
                className={cn(
      ...
      <div className="flex-1 px-8 pt-6 pb-8 space-y-8">
        <Card className="p-6">
