            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-zinc-500 leading-relaxed pr-4">
                        This will permanently delete <strong className="font-semibold text-zinc-700">"{teamName}"</strong> and all of its data. This action is irreversible and cannot be undone.
                    </DialogDescription>
                </DialogHeader>
