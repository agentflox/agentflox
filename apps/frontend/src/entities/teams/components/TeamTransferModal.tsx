...
export function TeamTransferModal({ teamId, teamName, open, onOpenChange, onSuccess }: TeamTransferModalProps) {
    ...
    const {
        ...
        {
            enabled: !!teamId && open && debouncedEmail.length >= 3,
            staleTime: 30_000,
            retry: false,
        }
    );
    ...
    const handleConfirmTransfer = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: `${displayName(selectedUser)} is now the owner of ${teamName}`,
            });
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-zinc-500 leading-relaxed pr-4">
                        This will transfer{" "}
                        <strong className="font-semibold text-zinc-700">"{teamName}"</strong> full
                        control of the team to the new owner, and you'll be downgraded to Admin.{" "}
