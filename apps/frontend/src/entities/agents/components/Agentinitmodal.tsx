...
const STEPS = [
  { 
    ...
    log: "Loading context and analyzing initialization parameters..." 
  },
  { 
    label: "Configuring capacities", 
    log: "Allocating agent memory and compute environments..." 
  },
  { 
    label: "Configuring integrations", 
    log: "Binding tools, skills, and external endpoints..." 
  },
  { 
    label: "Establishing secure channel", 
    log: "Negotiating protocols and establishing connection routes..." 
  },
  { 
    label: "Initializing session", 
    log: "Verifying configuration state and activating neural pathways..." 
  }
];

const STEP_MS = 2500;

type AgentInitMinimalProps = {
  open?: boolean;
};

export default function AgentInitMinimal({ open = true }: AgentInitMinimalProps) {
