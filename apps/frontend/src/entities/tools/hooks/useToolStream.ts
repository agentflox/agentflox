 ...
 */
export function useToolStream(callbacks: ToolStreamCallbacks = {}): UseToolStreamReturn {
            ...
            while (true) {
                ...
                for (const frame of frames) {
                    ...
                    try {
                        ...
                        console.warn('[useToolStream] Failed to parse SSE frame:', rawJson.substring(0, 100));
                        continue;
                    }
