		...
		<TooltipProvider delayDuration={200}>
			...
			>
				...
				<div className="p-3 flex flex-col gap-4 flex-1 pt-12 relative z-0">
					...
					{locationText && (
						<div className="flex items-center justify-between gap-2 text-xs text-slate-500 font-normal min-w-0 max-w-full">
							<Tooltip>
								<TooltipTrigger asChild>
									<div className="flex items-center gap-1.5 truncate min-w-0" title={locationText}>
							...
							{item.parent && (
								<Tooltip>
									<TooltipTrigger asChild>
										<div className="flex items-center gap-1 shrink-0 ml-auto text-zinc-400" title={item.parent.title}>
