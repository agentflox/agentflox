...
export function TaskDocPickerModal({
    ...
    const handleConfirm = (customItem?: { type: "TASK" | "DOCUMENT", id: string }) => {
        const item = customItem || selectedItem;
        if (item) {
            onSelect(item);
            onOpenChange(false);
    ...
    const renderBrowseTask = (t: any) => {
        ...
        return (
            <div
                ...
                onDoubleClick={() => handleConfirm({ type: "TASK", id: t.id })}
            >
                <div
                    className={cn(
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    onDoubleClick={() => {
                                                        ...
                                                        setTimeout(() => handleConfirm({ type: "TASK", id: t.id }), 0);
                                                    }}
                                                >
                                                    <div
                                                        className={cn(
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    onDoubleClick={() => {
                                                        ...
                                                        setTimeout(() => handleConfirm({ type: "DOCUMENT", id: doc.id }), 0);
                                                    }}
                                                >
                                                    <div
                                                        className={cn(
