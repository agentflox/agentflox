...
export function NewCustomRelationshipPopover({
    ...
    const createMutation = trpc.taskCustomRelationships.create.useMutation({
        onSuccess: () => {
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar">
                    ...
                    <div className="flex items-center justify-end gap-3 px-4 py-3 border-t border-zinc-100 shrink-0">
                        ...
                        <Button
                            className="h-9 px-4 rounded-lg text-[13px] font-semibold bg-indigo-500 hover:bg-indigo-600 text-white border-0"
                            disabled={!name || (relatedTo === 'specific' && !relatedList) || createMutation.isPending}
                            onClick={() => {
                                createMutation.mutate({
                                    workspaceId: workspaceId || undefined,
                                    name,
                                    relatedTo,
                                    relatedListId: relatedTo === 'specific' ? (relatedList || undefined) : undefined,
                                    createRollupFields,
                                    description,
