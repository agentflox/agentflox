...
import { Type, Check, ChevronDown, ChevronUp, Lock, ListChecks, Trash2, X, Info, MousePointer2, Eye, Pencil, Network, Briefcase, Building2, Folder as FolderIconLucide, Settings } from 'lucide-react';
                ...
                <DialogContent className="sm:max-w-[440px] gap-0 overflow-hidden p-0 rounded-2xl [&>button]:hidden">
                    ...
                    <div className="flex items-center justify-between px-3 py-2.5 border-b border-zinc-100">
                        <div className="flex items-center gap-1 text-[13px] font-medium text-zinc-600">
                            <DialogTitle className="text-[13px] font-medium text-zinc-600">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                type="button"
                                onClick={() => { onOpenChange(false); setManagerOpen(true); }}
                                className="flex items-center gap-1.5 text-[12px] font-medium text-zinc-600 hover:text-zinc-900 transition-colors cursor-pointer"
                            >
