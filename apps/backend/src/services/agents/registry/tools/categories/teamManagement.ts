        ...
        functionSchema: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    visibility: { type: 'string', enum: ['PRIVATE', 'ADMINS', 'MEMBERS', 'EVERYONE', 'PUBLIC'], description: 'Visibility level (default: PRIVATE)' },
        ...
        functionSchema: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    visibility: { type: 'string', enum: ['PRIVATE', 'ADMINS', 'MEMBERS', 'EVERYONE', 'PUBLIC'], description: 'New visibility level' },
