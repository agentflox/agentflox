        ...
        functionSchema: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    visibility: { type: 'string', enum: ['PRIVATE', 'ADMINS', 'MEMBERS', 'EVERYONE', 'PUBLIC'], description: 'Visibility level (default: PUBLIC)' },
        ...
        functionSchema: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    visibility: { type: 'string', enum: ['PRIVATE', 'ADMINS', 'MEMBERS', 'EVERYONE', 'PUBLIC'], description: 'Updated visibility level' },
