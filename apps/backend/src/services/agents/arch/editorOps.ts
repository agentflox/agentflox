/**
 * Editor-assistant operation schemas — backend copy.
 *
 * This file is the canonical source-of-truth for the backend.
 * The frontend has an identical copy at:
 *   apps/frontend/src/components/assistant/editorOps.ts
 *
 * Keep them in sync when adding new op types. A shared workspace package
 * (e.g. @agentflox/editor-ops) would be the ideal long-term solution.
 */
import { z } from 'zod';
