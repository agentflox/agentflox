          ...
          content: `
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-12">
              <div className="p-6 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl hover:border-indigo-500/30 transition-all group shadow-sm dark:shadow-none hover:shadow-md dark:hover:shadow-none">
                ...
                <h3 className="text-lg font-bold mb-3 text-slate-900 dark:text-white">Enterprise Workspaces</h3>
              ...
              <div className="p-6 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl hover:border-indigo-500/30 transition-all group shadow-sm dark:shadow-none hover:shadow-md dark:hover:shadow-none">
                ...
                <h3 className="text-lg font-bold mb-3 text-slate-900 dark:text-white">Venture Discovery</h3>
                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
      ...
      case "quick-start":
        return {
          ...
          content: `
            ...
            <ul className="list-disc ml-6 space-y-3 mb-10 text-slate-700 dark:text-slate-300">
        ...
        return {
          ...
          content: `
             <div className="flex flex-col items-center justify-center py-24 text-center">
                ...
                <h2 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">Documentation page under construction</h2>
                <p className="text-slate-600 dark:text-slate-400 max-w-md mx-auto">
                  We're currently refactoring our documentation system. 
                  In the meantime, check out the <Link href="/docs/introduction" className="text-indigo-600 dark:text-indigo-400 hover:underline">Introduction</Link> or <Link href="/docs/quick-start" className="text-indigo-600 dark:text-indigo-400 hover:underline">Quick Start</Link> guides.
                </p>
             </div>
          `,
